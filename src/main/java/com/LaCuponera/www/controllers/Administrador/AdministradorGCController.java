...
@WebServlet(name = "AdministradorGCController", urlPatterns = { "/administradorGC.do" })
public class AdministradorGCController extends HttpServlet {
	ArrayList<String> listaErrores = new ArrayList<>();
	AdministradorGCModel modelo = new AdministradorGCModel();
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter out = response.getWriter()) {
			...
			case "listar":
				...
				break;
			case "listinac":
				listinac(request, response);
				break;
			case "nuevo":
				request.getRequestDispatcher("/administrador/nuevoCliente.jsp").forward(request, response);
				break;
			case "insertar":
				break;
			case "obtener":
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
	...
	private void listar(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			request.getRequestDispatcher("/administrador/listarClientes.jsp").forward(request, response);
